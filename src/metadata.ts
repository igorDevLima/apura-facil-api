...
export default async () => {
  const t = {
    ...
    ['./modules/user/dtos/user.dto']:
      await import('./modules/user/dtos/user.dto'),
    ['./modules/auth/dto/token-payload.dto']:
      await import('./modules/auth/dto/token-payload.dto'),
    ['./common/dto/create-translation.dto']:
      await import('./common/dto/create-translation.dto'),
    ['./modules/auth/dto/login-payload.dto']:
      await import('./modules/auth/dto/login-payload.dto'),
    ['./modules/chat/dtos/user.dto']:
      await import('./modules/user/dtos/user.dto'),
    ['./modules/post/dtos/post.dto']:
      await import('./modules/post/dtos/post.dto'),
  };
  return {
    '@nestjs/swagger/plugin': {
      models: [
        ...
        [import('./common/dto/base.dto'), { BaseDto: {} }],
        [
